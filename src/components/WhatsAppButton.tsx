...
const WhatsAppButton = () => {
  ...
  return (
    ...
    >
      {/* Tooltip */}
      <motion.div
        className="pointer-events-none absolute bottom-full right-0 mb-3 whitespace-nowrap rounded bg-gray-900 px-3 py-2 font-sans text-xs text-white"
      ...
      <motion.a
        ...
        className="relative flex h-[60px] w-[60px] items-center justify-center rounded-full bg-[#25D366] sm:h-[60px] sm:w-[60px]"
